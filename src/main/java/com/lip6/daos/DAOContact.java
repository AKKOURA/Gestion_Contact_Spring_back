...
public class DAOContact implements IDAOContact {
	   ...
	   //cr�ation par setter
		...
		//cr�ation par constructeur
		@Autowired 
		private Contact contact2;
		
	//r�ation de contact par constructeur ou setter
	@Override
	public boolean addContact(Contact contact) {
		...
		//lorsque les assocations seront pr�sentes alors on persist que le contact)
	 ...
	 */
	//cr�ation de contact via le formulaire
	@Transactional
	@Override
